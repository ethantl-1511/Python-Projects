...
def load_gui(self):
    ...
    self.textfirstName = tk.Entry(self.master,text='')
    self.textfirstName.grid(row=1,column=0,rowspan=1,columnspan=2,padx=(30,40),pady=(0,0),sticky=N+E+W)
    ...
    self.textlastName.grid(row=3,column=0,rowspan=1,columnspan=2,padx=(30,40),pady=(0,0),sticky=N+E+W)
    # phone label/text
    ...
    self.textPhone.grid(row=5,column=0,rowspan=1,columnspan=2,padx=(30,40),pady=(0,0),sticky=N+E+W)
    # email label/text
    ...
    self.textEmail.grid(row=7,column=0,rowspan=1,columnspan=2,padx=(30,40),pady=(0,0),sticky=N+E+W)
    # course label/text
    ...
    self.textCourse.grid(row=9,column=0,rowspan=1,columnspan=2,padx=(30,40),pady=(0,0),sticky=N+E+W)
    # student label
    self.labelStudent = tk.Label(self.master,text='Students:')
    self.labelStudent.grid(row=0,column=2,padx=(25,0),pady=(10,0),sticky=N+W)

    # scrollbar and list
    self.scrollbar = Scrollbar(self.master,orient=VERTICAL)
    self.list1 = Listbox(self.master,exportselection=0,yscrollcommand=self.scrollbar.set)
